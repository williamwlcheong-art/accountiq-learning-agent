...
4. Architecture decision: Next.js/FastAPI/Postgres/Railway.
...
Expected: Phase 1 Security/Auth and Phase 2 Multi-User Isolation are complete in `.planning/`; Phase 05.1 and the Commercial MVP docs are the current planning focus.
...
```markdown
**Current state:** Phase 05.1 valuation advisory redesign is the active product-engineering thread. Commercial MVP public-funnel planning is captured in `docs/superpowers/specs/2026-07-01-commercial-mvp-roadmap-context.md` and `docs/superpowers/plans/2026-07-01-commercial-mvp-launch-gates-and-assumptions.md`.
```
...
**Must verify:**
- Auth/session cookies work in current app and planned Next.js shell.
...
**Must decide:**
- Next.js public site and app shell timing.
...
1. `2026-07-01-commercial-mvp-architecture.md`
2. `2026-07-01-marketing-site-offer.md`
3. `2026-07-01-customer-dashboard-report-history.md`
4. `2026-07-01-stripe-fulfillment-state-machine.md`
5. `2026-07-01-todd-review-queue.md`
