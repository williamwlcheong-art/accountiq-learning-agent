...
- ✓ Decimal FCFF engine merged in PR #20
- [x] Python-owned deterministic valuation tables: merged in PR #21
...
- PRs #15 to #20 are merged. They add authoritative document revisions, immutable snapshots and payment hardening, typed valuation inputs with the equity bridge, UI polish, frozen FCFF assumptions, adviser-approved WACC sets, and deterministic Decimal FCFF.
- PR #21 merged Python-owned, digested valuation tables and narrative-only model output for structured sections. William has not yet signed off the valuation method the PR #20 engine uses.
...
| Keep FCFF calculations and valuation tables deterministic | PR 3B uses a Decimal FCFF engine and PR 3C makes deterministic tables Python-owned before service rehearsal | Decimal engine merged in PR #20; tables merged in PR #21; method awaiting William's sign-off |
...
---
*Last updated: 2026-09-26, PRs #15 to #26 merged and PR #27 (marketing site) open. Next: William signs off the PR #20 valuation method, then explicitly approved live Anthropic UAT, then launch-gate closure or a private pilot.*
