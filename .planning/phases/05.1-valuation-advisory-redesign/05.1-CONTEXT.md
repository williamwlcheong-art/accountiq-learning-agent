> Update 2026-09-14: PR #21 merged on 2026-07-22; the no-network rehearsal landed in PRs #24 and #25. Current status lives in `.planning/BACKLOG.md`.

# Phase 5.5: Valuation Advisory Redesign — Context

**Gathered:** 2026-05-26
**Status:** PVM-08 hardening active; PRs #15 to #20 merged and PR #21 Python-owned deterministic valuation tables open. Review and merge PR #21 next, followed by the paid-report restart flow, synthetic runner updates and rehearsal, and separately approved live UAT.
...
- **D-W9:** Snapshot schema 2 and engine `fcff-decimal-v1` apply to new valuations. Completed pre-Decimal reports remain readable. Pending, queued, failed, or retryable pre-Decimal reports must restart and receive a new snapshot.
